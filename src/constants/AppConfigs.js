...
export const CHAIN_ID = process.env.NODE_ENV === 'production' ? process.env.REACT_APP_NETWORK_ID_PROD : process.env.REACT_APP_NETWORK_ID_LOCAL
...
export const NOTIFY_LINK = process.env.REACT_APP_NOTIFY_LINK
